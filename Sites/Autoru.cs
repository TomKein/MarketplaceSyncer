...
//        public async void AutoStartAsync(List<RootObject> bus) {
//            _bus = bus;
//            //await AuthAsync();
...
//                    if (_bus[b].auto.Contains("http") && (_bus[b].amount <= 0 || _bus[b].price < 100)) {
...
//                                    var elems = _dr.FindElements("div[class*='OffersItem']");
...
//                    Log.Add("auto.ru: ошибка браузера при попытке авторизации - " + x.Message);
//                    Quit();
//                    Thread.Sleep(120000);
//                    await AuthAsync();
//                }
