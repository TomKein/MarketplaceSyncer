...
|-----------|----------|-----------|
| ⚡ **FORCE** | Daily/Force Full Resync | **Высший приоритет (Parallel State).** По расписанию. Выполняется **параллельно** с Initial state (имеет свои курсоры). |
...
| 🟢 **LOW** | Full Reload (Lazy) | В свободное время. |
...
│ • Всегда выполняется перед Lazy Full Reload                     │
└─────────────────────────────────────────────────────────────────┘
                              ↓
                    Есть свободное время?
                              ↓
┌─────────────────────────────────────────────────────────────────┐
│ 🟢 LOW: Lazy Full Reload (фоновая проверка)                     │
├─────────────────────────────────────────────────────────────────┤
